...
- KPI strip (Messages sent, Total clicks, Reminder Uplift, CER %), black/green weekly/monthly toggle, Group + Dealer scope filters, a date range filter on the Reports title row, and Export CSV
