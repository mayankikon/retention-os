...
| Parent dealer group shown as secondary line under Dealer column (`getDealerGroup`) | Surfaces the group/company a dealership rolls up to without widening the table | Removed — column is Dealership name only |
